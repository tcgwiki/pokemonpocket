...
import { CardGroup, Set } from "~/db/payload-custom-types";
...
const columnHelper = createColumnHelper<CardGroup>();
   ...
   columnHelper.accessor("name", {
      ...
      cell: (info) => {
         return (
            <Link
               prefetch="intent"
               to={`/c/card-groups/${info.row.original.slug}`}
...
const COLLECTION = gql`
   query {
      listData: CardGroups(limit: 5000) {
         totalDocs
         docs {
            id
            name
